CREATE TABLE `mms_banking` (
	...
	`identifier` VARCHAR(50) NOT NULL DEFAULT '0' COLLATE 'utf8mb3_general_ci',
	`charidentifier` VARCHAR(50) NOT NULL DEFAULT '0' COLLATE 'utf8mb3_general_ci',
	`bankid` INT(11) NOT NULL DEFAULT '0',
	`balance` INT(11) NOT NULL DEFAULT '0',
	`goldbalance` INT(11) NOT NULL DEFAULT '0',
